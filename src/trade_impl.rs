impl CThostFtdcTraderApi {
                            ...
                            pub fn req_user_login(&mut self, p_req_user_login_field: &mut CThostFtdcReqUserLoginField, n_request_id: std::os::raw::c_int, length: TThostFtdcSystemInfoLenType, system_info: TThostFtdcClientSystemInfoType) -> std::os::raw::c_int {
                                    unsafe {
